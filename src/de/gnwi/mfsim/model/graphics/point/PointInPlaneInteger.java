 ...
 */
public class PointInPlaneInteger {
	 ...
	 *            Coordinate of the point on the vertical axis
	 */
	public PointInPlaneInteger(int aXCoordinate, int aYCoordinate) throws IllegalArgumentException {
	 ...
	 */
	public boolean isEqual(PointInPlaneInteger aPoint) {
	 ...
	 *            Coordinate of the point on the horizontal axis
	 */
	public void setX(int aXCoordinate) throws IllegalArgumentException {
		this.xCoordinate = aXCoordinate;
	}
	 ...
	 *            Coordinate of the point on the vertical axis
	 */
	public void setY(int aYCoordinate) throws IllegalArgumentException {
		this.yCoordinate = aYCoordinate;
	}
