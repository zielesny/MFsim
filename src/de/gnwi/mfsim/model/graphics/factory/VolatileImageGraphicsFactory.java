 ...
 *
 */
public class VolatileImageGraphicsFactory implements IGraphicsFactory {
     ...
     */
    private VolatileImage masterImage;
     ...
     */
    public VolatileImageGraphicsFactory(int aWidth, int aHeight, boolean anIsIntermediateImageCreation) {
    ...
    public void drawSinglePixel(int aXPosition, int aYPosition, Color aPixelColor) {
        ...
        if (aXPosition > -1 && aXPosition < this.width && aYPosition > -1 && aYPosition < this.height) {
            this.masterImageGraphics2D.setColor(aPixelColor);
            this.masterImageGraphics2D.drawLine(aXPosition, aYPosition, aXPosition, aYPosition);
        }
    }
    ...
    private void initialize(int aWidth, int aHeight) {
        ...
        this.masterImage = GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice().getDefaultConfiguration().createCompatibleVolatileImage(
        ...
        // ImageCapabilities tmpImageCapabilities = this.masterImage.getCapabilities(null);
        // System.out.println("Is this.masterImage accelerated = " + String.valueOf(tmpImageCapabilities.isAccelerated()));
